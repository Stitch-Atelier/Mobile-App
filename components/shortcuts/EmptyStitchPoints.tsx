  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.container3}>
        <TouchableOpacity
          onPress={() => navigation.navigate("Stitch" as never)}
          style={styles.button}
        >
          <Text style={styles.buttonText}>Book Now to Start Earning</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
...
export default EmptyStitchPoints;
